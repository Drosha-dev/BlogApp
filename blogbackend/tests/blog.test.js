...
describe('total likes', () => {
  ...
  test('of a list with nothing in it', () => {
...
describe('most likes', () => {
  ...
  test('when blog has mutlple entries', () => {
  ...
  //with current implementation its the first one added to list
  test('when blog has 2 people tied with likes', () => {
    const result = listHelper.favoriteBlog(listWithTiedLikesBlogs)
